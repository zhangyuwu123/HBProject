...
export default class ResultManage extends Component {
  ...
  componentDidMount() {
    ...
    if (type.type == 'dzxgc') {
      this.state.url = "http://demo.d9tec.com/api/app/getdzxxflist"
    } else if (type.type == 'smaqgc') {
      this.state.url = "http://demo.d9tec.com/api/app/getsmaqxflist"
    } else if (type.type == 'zhfzgc') {
      this.state.url = "http://demo.d9tec.com/api/app/getzhfzxflist"
